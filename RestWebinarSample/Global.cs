...
namespace RestWebinarSample
{
    public class Global
    {
        ...
        public static string g_URL = "http://192.168.1.21:32001/api/v1/";

        public static string g_UserName = "depoaktarim";   // Tiger girişinde kullanılan kullanıcı adı
        public static string g_UserPass = "2007";       
        public static string g_FirmNr = "221";        // Tiger tarafında bağlanılmak istenen firma
        ...
        //clientSecret    : 81NR3YL5HMIuKv3mERS1YKP8NmwwxpYi/0EWH5vXlnw=
        //
